...
{
    print_Log('proc_Log', 'mobile_head.php_start');
}
...
<header id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <button type="button" id="gnb_open" class="hd_opener">메뉴열기<span class="sound_only"> 열기</span></button>

        <div id="gnb" class="hd_div">
        <button type="button" id="gnb_close" class="hd_closer"><span class="sound_only">메뉴 </span>메뉴닫기</button>
            <ul id="gnb_1dul">
            <?php
            if($is_member)
            {
        ...
        $(function () {
            $(".hd_opener").on("click", function() {
                ...
                //alert('is_member:'+'<?php echo get_session(); ?>');   // 디버깅용
...
<div id="wrapper">
    <div id="aside">
        <?php echo outlogin('basic'); // 외부 로그인 outlogin_lib.php에 정의된 함수 ?>
    </div>
    <div id="container">
...
if(defined('DEBUG_MODE_PROCEDURE'))
{
    print_Log('proc_Log', 'mobile_head.php_end');
}
?>        