...
{
    print_Log('proc_Log', 'config.php_start');
}
...
*/
//define('G5_DOMAIN', 'http://52.35.188.219');
...
define('G5_SINSUN_URL',     G5_URL.'/'.G5_SINSUN_DIR);
