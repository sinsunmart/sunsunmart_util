...
{
    print_Log('proc_Log', 'outlogin.lib.php_start');
}
...
function outlogin($skin_dir='basic')
{
    ...
    if($is_member)
        {   
            include_once ($outlogin_skin_path.'/outlogin.skin.2.php');  // 로그인 후 
        }
    else // 로그인 전이라면
        {  
            include_once ($outlogin_skin_path.'/outlogin.skin.1.php');  // 로그인 전
        }
