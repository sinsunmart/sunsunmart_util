<?php
echo("<script>console.log('proc_Log : outlogin.skin.2.php');</script>");
...
<section id="ol_after" class="ol">
    <header id="ol_after_hd">
        ...
        <?php if ($is_admin == 'super' || $is_auth) { ?><a href="<?php echo G5_SINSUN_URL ?>/regist_expense.php" class="btn_admin">지출등록</a><?php } ?>
