...
{
    print_Log('proc_Log', 'common.php_start');
}
...
//echo('<script>console.log("member_id:'.$member['mb_id'].' ");</script>');
//alert('alert:'+ $member['mb_id']);
...
if(defined('DEBUG_MODE_PROCEDURE'))
{
    //print_Log('proc_Log', 'common.php_end');
}
?>